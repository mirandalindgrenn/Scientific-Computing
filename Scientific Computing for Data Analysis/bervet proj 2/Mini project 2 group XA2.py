...
fig, axes = plt.subplots(1, 3, figsize=(18, 6)) # Creates 3 subplots, one for the singular values of 3 and 8 and one for the normalized values
...
axes[2].set_ylabel('Normalized Singular Value')
axes[2].legend()
axes[2].grid(True)
plt.tight_layout()
plt.show()
